      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white transition-colors duration-300">Forex Page Management</h1>
              <p className="text-gray-600 dark:text-gray-300 transition-colors duration-300">Manage content, banners, and documents for the foreign exchange services page</p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600 px-6 py-4 transition-colors duration-300">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 transition-colors duration-300">Upload banner image for the foreign exchange services page</p>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="text-sm text-green-700 dark:text-green-300 space-y-1 transition-colors duration-300">
                    ...
                    <li>• Use professional images related to foreign exchange and currency</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600 px-6 py-4 transition-colors duration-300">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 transition-colors duration-300">Manage content and descriptions for foreign exchange services</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600 px-6 py-4 transition-colors duration-300">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 transition-colors duration-300">Manage downloadable files and documents for forex services</p>
              </div>
            </div>
          </div>
