      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white transition-colors duration-300">Mortgage Page Management</h1>
              <p className="text-gray-600 dark:text-gray-300 transition-colors duration-300">Manage content, banners, and documents for the mortgage product page</p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600 px-6 py-4 transition-colors duration-300">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 transition-colors duration-300">Upload banner image for the mortgage product page</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6">
            ...
            <div className="mt-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4 transition-colors duration-300">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-medium text-blue-900 dark:text-blue-100 mb-1 transition-colors duration-300">Banner Guidelines</h4>
                  <ul className="text-sm text-blue-700 dark:text-blue-300 space-y-1 transition-colors duration-300">
                    ...
                    <li>• Use high-quality images that represent mortgage services</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600 px-6 py-4 transition-colors duration-300">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 transition-colors duration-300">Manage content and descriptions for mortgage products</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600 px-6 py-4 transition-colors duration-300">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 transition-colors duration-300">Manage downloadable files and documents for mortgage products</p>
              </div>
            </div>
          </div>
